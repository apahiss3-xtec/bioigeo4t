export const sa6s3 = {
  ...
  engageContext: "Ja saps que les plaques es mouen i per què. Ara et falta el QUAN, perquè sense ordre no hi ha història. Treballaràs amb un tall geològic complet del teu planeta i un joc de fitxes de fòssils guia: hauràs d'ordenar tots els esdeveniments —dipòsits, plegaments, falles, intrusions, erosions— i correlacionar dues columnes de dos continents ara separats per demostrar que van estar junts. Acabaràs amb una pregunta de casa: per què hi ha fòssils de mar a dalt del Mont Caro?",

  // NO es renderitza al web: vocabulari de programació del docent
  // (tipologia de sessió, guió de moments). Tasca 2, 09/09/2026.
  teacherNotes: "Sessió de desenvolupament; és el cor de la feina de geòleg de Gondwana Tales.",
  ...
  theoryPoints: [
    ...
    },
    {
      ...
      text: "Cada capa és una ==escena==. Una ==calcària== plena de corals o closques et diu que allà hi havia un mar ==càlid== i poc profund. Un ==gres== amb marques d'ones, una platja o un ==riu==. Una argila fosca amb fulles, una ==llacuna== tranquil·la. Una capa de ==cendra==, un volcà a prop. Llegint-les de baix a dalt reconstrueixes com anava ==canviant== aquell lloc. I amb això s'expliquen coses que semblen impossibles. Exemple resolt, d'un altre indret: als ==Alps== hi ha capes amb closques marines a 3.000 m. Per llegir-ho es fan dues preguntes seguides, sempre en aquest ordre: (1) **on es formaria avui una roca com aquesta?** —al fons d'un mar— i (2) **què li ha passat després a aquell terreny?** —el xoc de dues plaques l'ha plegat i ==aixecat==. Les closques no van pujar soles: va pujar la ==roca== que les contenia. A l'apartat 4 del full faràs exactament aquestes dues preguntes, però amb dos llocs de casa que has de resoldre tu. El paisatge d'avui —el relleu, on va l'aigua, quina vegetació hi creix— és el resultat ==acumulat== de tot això, i cada element hi ==influeix== sobre els altres.",
      type: "concept"
    }
  ],
  ...
  exitTicketQuestions: [
    ...
    { id: "q3", type: "open", text: "Al Mont Caro, a 1.441 m d'altitud, hi ha roques calcàries amb fòssils marins. Explica com hi han arribat, fent servir l'actualisme i el que saps de la tectònica de plaques.", hint: "Fes-t'ho en dues preguntes i per ordre: on es formaria AVUI una roca com aquesta, i què li pot haver passat després a aquell terreny segons el que saps de les plaques." }
  ],
