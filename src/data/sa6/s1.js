export const sa6s1 = {
  ...
  engageContext: "No cal que arribis sabent res: cal que et facis les preguntes bones. Per què hi ha terratrèmols, volcans o serralades? En equip faràs d'investigador amb el mapa del planeta: intentaràs encaixar-ne els continents i faràs servir els fòssils guia com a proves per decidir quins estaven junts. D'aquí sortiran la deriva continental de Wegener, la tectònica de plaques i què les mou per dins. Acabaràs predient cap on aniran els continents. La memòria del planeta és a les proves; la teva feina és aprendre a llegir-la.",

  // NO es renderitza al web: vocabulari de programació del docent
  // (tipologia de sessió, guió de moments). Tasca 2, 09/09/2026.
  teacherNotes: "Sessió d'activació que obre la situació de geologia. Comença recollint idees prèvies sobre terratrèmols, volcans i serralades abans de repartir els mapes.",
