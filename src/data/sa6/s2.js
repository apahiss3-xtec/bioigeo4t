export const sa6s2 = {
  ...
  engageContext: "Ja saps que els continents es mouen. Avui vas al PER QUÈ i al COM HO SABEM. Posarem en comú la notícia de terratrèmol o volcà que has portat de casa i la situarem sobre els límits de plaques. Després dissenyaràs un model per posar a prova la teva hipòtesi sobre el motor de les plaques: la convecció. No busques que «surti bé»: busques que el model et deixi observar alguna cosa que confirmi o desmenteixi la teva hipòtesi. Acabaràs ordenant la història d'una columna d'estrats.",

  // NO es renderitza al web: vocabulari de programació del docent
  // (tipologia de sessió, guió de moments). Tasca 2, 09/09/2026.
  teacherNotes: "Sessió de desenvolupament. Del QUÈ (S1) al PER QUÈ i al COM HO SABEM. Model d'indagació d'equip: convecció i, opcionalment, estratificació. Contingut posterior: convecció del mantell i cicle de Wilson.",
