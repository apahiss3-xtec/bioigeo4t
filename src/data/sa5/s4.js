export const sa5s4 = {
  ...
  engageContext: "Avui no s'aprèn res nou: es demostra. Cada equip presenta la seva targeta-cas i defensa el seu organisme al museu del pati; després visites els altres estands i els puntues amb la rúbrica, donant sempre una millora concreta. I acabes sol davant d'un cas nou —el peix globus o la tolerància a la lactosa— per analitzar-lo des de les quatre teories.",

  // NO es renderitza al web: vocabulari de programació del docent
  // (tipologia de sessió, guió de moments). Tasca 2, 09/09/2026.
  teacherNotes: "Sessió de síntesi i avaluació, tres moments: museu + coavaluació amb rúbrica + exercici individual tipus PAU. Tancar amb la metacognició de tota la situació i del trimestre.",
  ...
  exitTicketQuestions: [
    ...
    { id: "q3", type: "open", text: "En un dels dos casos anteriors, escriu com l'explicaria (malament) el lamarckisme i digues quina prova concreta descartaria aquesta explicació lamarckiana.", hint: "Per a la primera part, mira on col·loca Lamarck l'origen del canvi (abans o després de néixer?). Per a la segona, busca una prova sobre què es transmet i què no." }
  ],
