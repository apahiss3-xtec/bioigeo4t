export const sa7s1 = {
  ...
  engageContext: "No cal que arribis sabent res: cal que et facis les preguntes bones. Què creus que se sap de veritat sobre l'origen de l'univers, de la Terra i de la vida? En equip faràs de comitè editorial d'una revista de divulgació: rebràs afirmacions reals sobre l'espai i n'hauràs de decidir el grau de certesa amb la mateixa escala que vas construir al principi de curs. D'aquí sortiran el Big Bang i les seves proves, la formació del sistema solar i de la Terra, i què vol dir de debò l'escala del temps còsmic. La idea que ho lliga tot: mirar lluny és mirar enrere.",

  // NO es renderitza al web: vocabulari de programació del docent
  // (tipologia de sessió, guió de moments). Tasca 2, 09/09/2026.
  teacherNotes: "Sessió d'activació que obre la darrera situació del curs. Recollir primer les idees prèvies; l'escala de certeses ve de la SA1.",
