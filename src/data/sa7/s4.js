export const sa7s4 = {
  ...
  engageContext: "Avui hi ha un debat de veritat, amb torns i regles, sobre una qüestió que barreja ciència i valors: enmig hi haurà un torn en què hauràs de defensar la postura contrària a la teva. Després tanques el curs sencer: recuperaràs l'escala de certeses de la primera situació i miraràs com ha canviat, al llarg de l'any, la teva manera de decidir que una cosa és veritat.",

  // NO es renderitza al web: vocabulari de programació del docent
  // (tipologia de sessió, guió de moments). Tasca 2, 09/09/2026.
  teacherNotes: "Darrera sessió del curs, tres parts: debat regulat (amb torn d'inversió de postura), tancament metacognitiu del curs i prova escrita final. La prova no és de memòria: situació nova que barreja continguts de situacions diferents.",
