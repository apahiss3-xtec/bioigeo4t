export const sa7s3 = {
  ...
  fitxaGuide: {
    ...
    steps: [
      ...
      { apartat: "3", title: "Tres problemes, tres escenaris", time: "16 min (A: 22)", phase: "explain", instruction: "Amb la Fig.2, escriu quin problema resol millor cada escenari i quin continua sense resoldre. Després calcula la finestra de temps amb la Fig.3.", hints: ["Mira el dibuix de cada escenari i pregunta't què hi ha, allà, que no hi ha als altres dos.", "Per a cada escenari has de dir dues coses: què resol millor i què continua sense resoldre."] },
      ...
      { apartat: "5", title: "Posada en comú i fonts", time: "14 min (A: 8)", phase: "elabora", instruction: "Comparem els dictàmens dels equips i, a la fitxa, escriviu la prova que vau portar de casa i avalueu-ne la font amb la graella de fiabilitat de la SA1.", hints: [] },
