export const sa7s2 = {
  ...
  fitxaGuide: {
    ...
    steps: [
      ...
      { apartat: "4", title: "El laboratori de datació", time: "28 min (B) / 32 min (A)", phase: "elabora", instruction: "Per a cada mostra: tria el rellotge amb la Fig.5, calcula l'edat i escriu què no pots afirmar. Amb la mostra que no es pot datar, digues què dataries en lloc seu i acota'n l'edat amb la Fig.6. Tanca l'apartat amb la posada en comú de la classe (10 min) i la metacognició del final de la fitxa (5 min): totes dues són dins d'aquest mateix apartat 4, no en tenen un de propi.", hints: ["Comprova sempre que l'edat que esperes cau dins la franja on el rellotge serveix, i mira també la columna del material.", "Compta quantes vegades has de partir per la meitat per arribar a la fracció que queda."] }
    ]
  },
