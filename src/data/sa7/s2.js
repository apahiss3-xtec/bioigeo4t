export const sa7s2 = {
  ...
  fitxaGuide: {
    ...
    steps: [
      ...
      { apartat: "4", title: "El laboratori de datació", time: "28 min (B) / 32 min (A)", phase: "elabora", instruction: "Per a cada mostra: tria el rellotge amb la Fig.5, calcula l'edat i escriu què no pots afirmar. Amb la mostra que no es pot datar, digues què dataries en lloc seu i acota'n l'edat amb la Fig.6.", hints: ["Comprova sempre que l'edat que esperes cau dins la franja on el rellotge serveix, i mira també la columna del material.", "Compta quantes vegades has de partir per la meitat per arribar a la fracció que queda."] },
      { apartat: "5", title: "Posada en comú de la classe", time: "10 min", phase: "elabora", instruction: "Comparem els informes de laboratori dels equips i decidim junts què es fa amb la mostra que no es pot datar directament.", hints: [] },
      { apartat: "6", title: "Metacognició", time: "5 min", phase: "evaluate", instruction: "Torna a l'apartat 0, mira què has canviat i respon les tres preguntes finals de la fitxa.", hints: [] }
    ]
  },
