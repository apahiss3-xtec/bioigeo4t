export const sa7s2 = {
  ...
  engageContext: "Aquesta sessió té dues meitats que s'acaben trobant. Primer miraràs què fa que un planeta pugui tenir aigua líquida a la superfície, i comprovaràs que estar al lloc adequat no ho garanteix. Després faràs, en equip, una simulació amb daus que reprodueix el comportament d'un àtom inestable: cada dau té la mateixa probabilitat de «desintegrar-se» a cada tirada, però tu no pots saber quin caurà. D'aquí en surt la idea de semivida, i de la semivida, el mètode amb què es data una roca. Al final actuareu com un laboratori de datació que ha de posar edat a unes mostres i decidir, en un cas, que no es pot.",

  // NO es renderitza al web: vocabulari de programació del docent
  // (tipologia de sessió, guió de moments). Tasca 2, 09/09/2026.
  teacherNotes: "Sessió de desenvolupament. Les dues meitats (zona d'habitabilitat i semivida) han de convergir al laboratori de datació final.",
